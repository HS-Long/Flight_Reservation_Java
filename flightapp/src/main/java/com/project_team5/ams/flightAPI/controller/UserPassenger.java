...
public class UserPassenger {
    ...
    @PostMapping("/create")
    public String createPassenger(@ModelAttribute("passengers") Passenger passenger) {
    ...
    public String showUpdateForm(@PathVariable Long id, Model model, RedirectAttributes redirectAttributes) {
        ...
        if (optionalPassenger.isPresent()) {
            model.addAttribute("passengers", optionalPassenger.get());
    ...
    public String updatePassenger(@PathVariable Long id, @ModelAttribute("passengers") Passenger updatedPassenger) {
        Optional<Passenger> optionalPassenger = repository.findById(id);
        if (optionalPassenger.isPresent()) {
